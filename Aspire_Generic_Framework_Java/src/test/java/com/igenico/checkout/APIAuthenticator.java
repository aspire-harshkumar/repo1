...
import com.igenico.checkout.RequestHeader;
...
public class APIAuthenticator {
	...
	public APIAuthenticator(AuthorizationType authorizationType, String apiKeyId, String secretApiKey) {
	...
	public String createAuthenticationSignature(String httpMethod, URI resourceUri, List<RequestHeader> httpHeaders) {
		...
		String singedData = prepareSignedData(httpMethod, resourceUri, httpHeaders);
		return "GCS " + authorizationType.getSignatureString() + ":" + apiKeyId + ":" + base64HMACSignature(singedData);
	}

	
	
	public String prepareSignedData(String httpMethod, URI resourceUri, List<RequestHeader> httpHeaders) {
	 ...
	 */
	public String base64HMACSignature(String dataToSign) {
